...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	while (1) {
		...
		SetFontSize(24);
		DrawString(200, 170, "vs 人間", WHITE);
		DrawString(200, 190, "vs コンピューター Lv1", WHITE);
		DrawString(200, 210, "vs コンピューター Lv2", WHITE);
		DrawString(200, 230, "vs コンピューター Lv3", WHITE);
		DrawString(200, 270, "START →→→ A", WHITE);
